	...
	return (
		<header id="header" className="container">
			...
			<div className="overflowHidden">
				<div className={`responsive-wrapper ${navbarOpen && "show"}`}>
					<ul id="navbar">
						<li>
							<Link
								to="/"
						...
						<li>
							...
							<div className={`resource-popup-menu ${popupOpen && "show"}`}>
								<a href="#" className="popup-block">
									<h5>Custom Icon Set</h5>
									<p>
										5,000+ custom designed icons across 4
										different styles to user in your
										projects. Included with your Lookscout
										pack.
									</p>
								...
								<a href="#" className="popup-block">
									...
									<p>
										Custom & versatile pre-made UI Kits for
